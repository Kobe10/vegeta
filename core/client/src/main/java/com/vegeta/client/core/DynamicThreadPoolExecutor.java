...
import com.vegeta.client.alarm.ThreadPoolAlarmManage;
import com.vegeta.client.event.EventExecutor;
...
//    }
    ...
    private ConcurrentHashMap<String, Date> statisticsTime = new ConcurrentHashMap(Constants.MAP_INITIAL_CAPACITY);
