 ...
 * @author fuzhiqiang
 */
public class VegetaException extends Exception {
    ...
    public VegetaException() {
    }

    public VegetaException(final int errCode, final String errMsg) {
        super(errMsg);
        this.errCode = errCode;
        this.errMsg = errMsg;
    }

    public VegetaException(final int errCode, final Throwable throwable) {
        super(throwable);
        this.errCode = errCode;
        this.setCauseThrowable(throwable);
    }

    public VegetaException(final int errCode, final String errMsg, final Throwable throwable) {
